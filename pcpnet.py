...
class PointNetfeat(nn.Module):
    def __init__(self, num_scales=1, num_points=512, use_point_stn=True, use_feat_stn=True, sym_op='max', get_pointfvals=False, point_tuple=1):
        ...
        if self.sym_op == 'max':
            self.mp1 = torch.nn.MaxPool1d(int(num_points/32))
...
class PCPNet(nn.Module):
    def __init__(self, num_points=512, output_dim=3, use_point_stn=True, use_feat_stn=True, sym_op='max', get_pointfvals=False, point_tuple=1):
